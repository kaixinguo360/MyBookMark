...
check_table($album_table, "CREATE TABLE $album_table (id INT(3) AUTO_INCREMENT PRIMARY KEY, name CHAR(64) UNIQUE, info TEXT, tags TEXT, except TEXT, sort CHAR(4), loadingimg VARCHAR(255));");
